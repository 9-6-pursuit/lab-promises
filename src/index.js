...
function logThreeResultsCities(person1, person2, person3) {
  ...
  promise1.then(result => {console.log(result[0].city)}).catch(error => {console.log(error)})
  promise2.then(result => {console.log(result[0].city)}).catch(error => {console.log(error)})
  promise3.then(result => {console.log(result[0].city)}).catch(error => {console.log(error)})
