...
function logThreeResultsCities(person1, person2, person3) {
  let firstCityPromise = finder(person1.first, person1.last);
  firstCityPromise
    .then((result) => {
  ...
  let secondCityPromise = finder(person2.first, person2.last);
  secondCityPromise
    .then((result) => {
      console.log(result[0].city);
    })
  ...
  let thirdCityPromise = finder(person3.first, person3.last);
  thirdCityPromise
    .then((result) => {
      console.log(result[0].city);
    })
